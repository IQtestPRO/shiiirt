# Assets recomendados - Web Performance and Core Web Vitals
...
- "high converting landing page performance interface"
- "business website performance clean ui"
...
Crie uma imagem para Web Performance and Core Web Vitals em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
