# Exemplos - Visual Hierarchy

## SaaS B2B
Dashboard mockup maior que bullets secundários.
...
## E-commerce
Preço e botão de compra dominam buy box.
...
Oferta, data e inscrição aparecem antes de longas biografias.
