# Assets recomendados - Hero Section Optimization

## Tipos de assets
- Mockup de produto
- Screenshot real
- Foto lifestyle permissiva
- Selo de prova

## Termos de busca seguros
- "high converting landing page hero interface"
- "business website hero clean ui"
...
Crie uma imagem para Hero Section Optimization em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
