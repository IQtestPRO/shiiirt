# Exemplos - Mobile-First UX

## SaaS B2B
CTA sticky de demo após hero e screenshot recortado para celular.
...
## E-commerce
Buy box acima de descrições longas e seleção de variante grande.
...
Inscrição em uma coluna com resumo fixo do bônus.
