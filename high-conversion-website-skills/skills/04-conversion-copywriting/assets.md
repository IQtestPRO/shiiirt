# Assets recomendados - Conversion Copywriting

## Tipos de assets
- Banco de frases do cliente
- Matriz de objeções
- Tabela de promessas

## Termos de busca seguros
- "high converting landing page copy interface"
- "business website copy clean ui"
...
Crie uma imagem para Conversion Copywriting em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
