# Assets recomendados - A/B Testing and Experimentation
...
- "high converting landing page experimentation interface"
- "business website experimentation clean ui"
...
Crie uma imagem para A/B Testing and Experimentation em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
