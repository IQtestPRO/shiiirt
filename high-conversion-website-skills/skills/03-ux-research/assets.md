# Assets recomendados - UX Research for Conversion

## Tipos de assets
- Planilha de entrevistas
- Modelo de tarefa
- Matriz severidade x frequência

## Termos de busca seguros
- "high converting landing page research interface"
- "business website research clean ui"
...
Crie uma imagem para UX Research for Conversion em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
