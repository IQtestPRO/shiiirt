# Assets recomendados - CTA Design

## Tipos de assets
- Estados de botão
- Mapa de CTAs por seção
- Ícones de seta/check em SVG

## Termos de busca seguros
- "high converting landing page cta interface"
- "business website cta clean ui"
...
Crie uma imagem para CTA Design em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
