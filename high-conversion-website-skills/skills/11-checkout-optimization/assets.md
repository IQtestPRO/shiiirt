# Assets recomendados - Checkout Optimization
...
- "high converting landing page checkout interface"
- "business website checkout clean ui"
...
Crie uma imagem para Checkout Optimization em estilo editorial moderno, sem marcas, sem logos, sem pessoas identificáveis, com fundo limpo, iluminação natural, espaço para texto e proporção 16:9 para desktop e 4:5 para mobile.
